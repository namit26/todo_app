...
<div id="login1" class="w3-container ">
    ...
    <form action="" method="POST" style="width: 50%; margin-left: 25%;">
        ...
        <input class="w3-input w3-animate-input w3-padding-8" type="text" style="width:33%" name="password" required>
...
<div id="signup1" class="w3-container ">
    ...
    <form  name="signupform" id="signupformid" method="POST" style="width: 50%; margin-left: 25%;">
        ...
        <button class="w3-input w3-animate-input w3-padding-8" id="test" type = "button" value = "button" />

    </form>

    <%--<button class="w3-input w3-animate-input w3-padding-8" onclick="submit()" type = "button" value = "button" />--%>
